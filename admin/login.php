...
// hàm destroy sẽ giữ session đến khi làm việc cuối cùng
// xóa toàn bộ session
// session_destroy();
...
if(isset($_POST['login'])) {
	...
	if(!isset($error['email']) &&  !isset($error['pass'])) {
		...
		/**
		 * mysqli_fetch_assoc: chuyển đổi về mảng kết hợp (key là string)
		 * 
	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading">ADAM STORE - Administrator</div>
